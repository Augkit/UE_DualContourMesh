	...
	if (IsLocalPlayerController())
	{
		...
		if (ShouldUseTouchControls())
		{
			...
			if (MobileControlsWidget)
			{
				...
				UE_LOG(LogDualContourGamePlay, Error, TEXT("Could not spawn mobile controls widget."));
		...
		if (BulletCounterUI)
		{
			...
			UE_LOG(LogDualContourGamePlay, Error, TEXT("Could not spawn bullet counter widget."));
